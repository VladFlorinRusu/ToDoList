...
class TaskTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell?.delegate = self
        cell?.addGesture(at: indexPath.row)
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if let editTaskVC = storyboard?
            .instantiateViewController(identifier: "AddEditTaskViewController") as? AddEditTaskViewController {
    ...
    @objc func addNewTask() {
        if let addNewTaskVC = storyboard?
            .instantiateViewController(identifier: "AddEditTaskViewController") as? AddEditTaskViewController {
    ...
    private func configureTable() {
        ...
        addNavBarButton.target = self
        addNavBarButton.action = #selector(addNewTask)
